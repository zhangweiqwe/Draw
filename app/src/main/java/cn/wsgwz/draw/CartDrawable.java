...
public class CartDrawable extends Drawable implements Animatable {
    private static final String TAG = CartDrawable.class.getSimpleName();
    ...
    public CartDrawable(Context context,int flag,boolean isLastVersion) {


        icon_cart = context.getResources().getDrawable(R.mipmap.ic_launcher);
        mPaint = new Paint();
    ...
    private void drawText(Canvas canvas, String text) {
        ...
        canvas.drawRoundRect(numRectF, 10, 10, mPaint);
